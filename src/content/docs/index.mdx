...
template: splash
hero:
  tagline: AI agents that plan, build, review, and ship your sprint — day by day. v1.0.0 now available.
  actions:
    - text: Quickstart
      ...
      variant: primary
    - text: View on GitHub
      link: https://github.com/pace-framework-org/pace-framework-starter
      icon: external
      variant: minimal
---
